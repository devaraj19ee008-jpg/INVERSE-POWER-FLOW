...
GENERATOR_DATA = [
    ...
    [2, "Gen_2_2", "SYNC", 2, 163, 0, 1, -300, 300, 1, 1, 1],
    [3, "Gen_3_3", "SYNC", 3, 85, 0, 1, -300, 300, 1, 1, 1],
]

# ========== LOAD DATA ==========
# Format: [load_num, load_name, bus, P_demand, Q_demand, model, area, zone]
LOAD_DATA = [
    [1, "Load_5", 5, 90, 30, "constant_PQ", 1, 1],
    [2, "Load_7", 7, 100, 35, "constant_PQ", 1, 1],
    [3, "Load_9", 9, 125, 50, "constant_PQ", 1, 1],
]
